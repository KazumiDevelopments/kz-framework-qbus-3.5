...
RLCore.Functions.CreateUseableItem("anchor", function(source, item)
...
RLCore.Functions.CreateUseableItem("fishicebox", function(source, item)
    local Player = RLCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
...
RLCore.Functions.CreateUseableItem("fishinglootbig", function(source, item)
	local src = source
...
RLCore.Functions.CreateUseableItem("fishingloot", function(source, item)
	local src = source
    local Player = RLCore.Functions.GetPlayer(src)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
		Player.Functions.RemoveItem("fishingloot", 1)
		TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['fishingloot'], "remove", 1)
		TriggerClientEvent('RLCore:Notify', src, "Opening Box", "primary")
		SetTimeout(1000, function()
			Player.Functions.AddItem('fishingkey', 1, nil, {["quality"] = 100}) 
			TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['fishingkey'], "add", 1)

			Player.Functions.AddItem(Config.smallLootboxReward, 1, nil, {["quality"] = 100}) 
			TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items[Config.smallLootboxReward], "add", 1)

			Player.Functions.AddMoney('cash', Config.smallLootboxCash, "fishingloot")
			TriggerClientEvent('RLCore:Notify', src, "You found a couple items and $"..Config.smallLootboxCash, "success")
		end)
    end
end)

RLCore.Functions.CreateUseableItem("fishtacklebox", function(source, item)
	local src = source
    local Player = RLCore.Functions.GetPlayer(src)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then

		TriggerClientEvent('RLCore:Notify', src, "Opening Tackel Box", "success")
		Player.Functions.RemoveItem("fishtacklebox", 1)
		TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['fishtacklebox'], "remove", 1)

		SetTimeout(1250, function()
			Player.Functions.AddItem('pearlscard', 1, nil, {["quality"] = 100}) 
			TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['pearlscard'], "add", 1)
		end)
    end
end)
...
RegisterNetEvent('fishing:server:removeFishingBait', function()
    ...
    TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['fishbait'], "remove", 1)
end)

RegisterNetEvent("fishing:server:addTackleBox", function()
	local src = source
	local Player = RLCore.Functions.GetPlayer(src)
	TriggerClientEvent('RLCore:Notify', src, "There seems to tackle box left over from another fisherman", "primary")
	SetTimeout(1000, function()
		Player.Functions.AddItem('fishtacklebox', 1, nil, {["quality"] = 100}) 
		TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['fishtacklebox'], "add", 1)
	end)
end) 
...
RegisterNetEvent("fishing:server:returnDeposit", function()
	...
	TriggerClientEvent('RLCore:Notify', src, "Boat has been returned for $"..price, "success")
end) 
    ...
    if itemFound then
        for i = 1, itemCount, 1 do
            if luck == 100 then
				...
				TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['killerwhale'], "add", 1)
				TriggerClientEvent('RLCore:Notify', src, "You caught a killer whale!\nThese are endangered species and are illegal to possess", "primary")
			elseif luck >= 95 and luck <= 100 then
				Player.Functions.AddItem('fishinglootbig', 1, nil, {["quality"] = 100})
				TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['fishinglootbig'], "add", 1)
				TriggerClientEvent('RLCore:Notify', src, "You found a Treasure Chest!", "success")
			elseif luck >= 90 and luck <= 95 then
				...
				TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['dolphin'], "add", 1)
				TriggerClientEvent('RLCore:Notify', src, "You caught a dolphin!\nThese are endangered species and are illegal to possess", "primary")
			elseif luck >= 85 and luck <= 90 then
				...
				TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['sharkhammer'], "add", 1)
				TriggerClientEvent('RLCore:Notify', src, "You caught a hammerhead shark!\nThese are endangered species and are illegal to possess", "primary")
			elseif luck >= 80 and luck <= 85 then
				...
				TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['sharktiger'], "add", 1)
				TriggerClientEvent('RLCore:Notify', src, "You caught a tiger shark!\nThese are endangered species and are illegal to possess", "primary")
			elseif luck >= 75 and luck <= 80 then
				...
				TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['stingray'], "add", 1)
				TriggerClientEvent('RLCore:Notify', src, "You caught a "..weight.."lbs Stingray!", "success")
			elseif luck >= 70 and luck <= 75 then
				...
				TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['flounder'], "add", 1)
				TriggerClientEvent('RLCore:Notify', src, "You caught a " .. weight .. "lbs Flounder", "success")
			elseif luck >= 65 and luck <= 70 then
				Player.Functions.AddItem('fishingboot', 1, nil, {["quality"] = 100})
				TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['fishingboot'], "add", 1)
				TriggerClientEvent('RLCore:Notify', src, "You caught a fishing boot!", "primary")
			elseif luck >= 60 and luck <= 65 then
				...
				TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['bass'], "add", 1)
				TriggerClientEvent('RLCore:Notify', src, "You caught a " .. weight .. "lbs Bass", "success")
			elseif luck >= 55 and luck <= 60 then
				Player.Functions.AddItem('fishingloot', 1, nil, {["quality"] = 100})
				TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['fishingloot'], "add", 1)
				TriggerClientEvent('RLCore:Notify', src, "You found a small box!", "success")
			elseif luck >= 50 and luck <= 55 then
				...
				TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['codfish'], "add", 1)
				TriggerClientEvent('RLCore:Notify', src, "You caught a " .. weight .. "lbs  Cod", "success")
			elseif luck >= 45 and luck <= 50 then
				Player.Functions.AddItem('fishingtin', 1, nil, {["quality"] = 100})
				TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['fishingtin'], "add", 1)
				TriggerClientEvent('RLCore:Notify', src, "You caught a fishing tin!", "primary")
			elseif luck >= 0 and luck <= 45 then
				...
				TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['mackerel'], "add", 1)
				TriggerClientEvent('RLCore:Notify', src, "You caught a " .. weight .. "lbs Mackerel", "success")
            end
            Citizen.Wait(500)
        end
    end
...
RegisterNetEvent('fishing:server:SellillegalFish', function(args)
	...
	if args == 1 then 
		...
		if dolphin ~= nil then
			...
			TriggerClientEvent('inventory:client:ItemBox', source, RLCore.Shared.Items['dolphin'], "remove", 1)
			TriggerClientEvent('RLCore:Notify', src, "Dolphin Sold for $"..payment, "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('RLCore:Notify', src, "You dont have any Dolphin to sell", 'error')
		end
	elseif args == 2 then 
		...
		if sharktiger ~= nil then
			...
			TriggerClientEvent('inventory:client:ItemBox', source, RLCore.Shared.Items['sharktiger'], "remove", 1)
			TriggerClientEvent('RLCore:Notify', src, "Tiger Shark Sold for $"..payment, "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('RLCore:Notify', src, "You dont have any Tiger Shark to sell", 'error')
		end
	elseif args == 3 then 
		...
		if sharkhammer ~= nil then
			...
			TriggerClientEvent('inventory:client:ItemBox', source, RLCore.Shared.Items['sharkhammer'], "remove", 1)
			TriggerClientEvent('RLCore:Notify', src, "Hammerhead Shark Sold for $"..payment, "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('RLCore:Notify', src, "You dont have any Hammerhead Shark to sell", 'error')
		end
	else
		...
		if killerwhale ~= nil then
			...
			TriggerClientEvent('inventory:client:ItemBox', source, RLCore.Shared.Items['killerwhale'], "remove", 1)
			TriggerClientEvent('RLCore:Notify', src, "Killer Whale Sold for $"..payment, "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('RLCore:Notify', src, "You dont have any Killer Whale to sell", "error")
		end
	end
end)
...
RegisterNetEvent('fishing:server:SellLegalFish', function(args) 
	...
	if args == 1 then 
		...
		if mackerel ~= nil then
			...
			TriggerClientEvent('inventory:client:ItemBox', source, RLCore.Shared.Items['mackerel'], "remove", 1)
			TriggerClientEvent('RLCore:Notify', src, "1 Mackerel Sold for $"..payment, "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('RLCore:Notify', src, "You dont have any Mackerels to sell", "error")
		end
	elseif args == 2 then
		...
		if codfish ~= nil then
			...
			TriggerClientEvent('inventory:client:ItemBox', source, RLCore.Shared.Items['codfish'], "remove", 1)
			TriggerClientEvent('RLCore:Notify', src, "1 Cod Sold for $"..payment, "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
	...
	elseif args == 3 then
		...
		if bass ~= nil then
			...
			TriggerClientEvent('RLCore:Notify', src, "You dont have any Bass to sell", "error")
		end
	elseif args == 4 then
		...
		if flounder ~= nil then
			...
			TriggerClientEvent('inventory:client:ItemBox', source, RLCore.Shared.Items['flounder'], "remove", 1)
			TriggerClientEvent('RLCore:Notify', src, "1 Flounder Sold for $"..payment, "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('RLCore:Notify', src, "You dont have any Flounders to sell", "error")
		end
	else
		...
		if stingray ~= nil then
			...
			TriggerClientEvent('inventory:client:ItemBox', source, RLCore.Shared.Items['stingray'], "remove", 1)
			TriggerClientEvent('RLCore:Notify', src, "1 Stingray Sold for $"..payment, "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('RLCore:Notify', src, "You dont have any Stingray to sell", "error")
		end
	end
end)
...
RegisterNetEvent('fishing:server:BuyFishingGear', function(args)
	...
	if args == 1 then 
		if bankBalance >= Config.fishingBaitPrice then
			...
			TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['fishbait'], "add", 1)
	...
	elseif args == 2 then 
		if bankBalance >= Config.fishingRodPrice then
			...
			TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['fishingrod'], "add", 1)
			TriggerClientEvent("doj:client:buyFishingGear", source)
		else
			TriggerClientEvent('RLCore:Notify', src, "You dont have enough money..", "error")
		end
	elseif args == 3 then 
		if bankBalance >= Config.BoatAnchorPrice then
			...
			TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['anchor'], "add", 1)
			TriggerClientEvent("doj:client:buyFishingGear", source)
		else
			TriggerClientEvent('RLCore:Notify', src, "You dont have enough money..", "error")
		end
		...
		if bankBalance >= Config.BoatAnchorPrice then
			...
			TriggerClientEvent('inventory:client:ItemBox', src, RLCore.Shared.Items['fishicebox'], "add", 1)
			TriggerClientEvent("doj:client:buyFishingGear", source)
		else
			TriggerClientEvent('RLCore:Notify', src, "You dont have enough money..", "error")
		end
...
--============================================================================ Callbacks
RLCore.Functions.CreateCallback('fishing:server:checkMoney', function(source, cb)
    local src = source
    local pData = RLCore.Functions.GetPlayer(src)
    ...
    if bankBalance >= price then
		...
		TriggerClientEvent('RLCore:Notify', src, "Boat has been rented for $"..price, "success")
        cb(true)
    else
        TriggerClientEvent('RLCore:Notify', src, "You dont have enough money..", "error")
        cb(false)
