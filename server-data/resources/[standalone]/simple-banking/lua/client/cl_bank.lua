...
RegisterNetEvent("rl-banking:client:ExtNotify")
AddEventHandler("rl-banking:client:ExtNotify", function(msg)
	if (not msg or msg == "") then return end

	RLCore.Functions.Notify(msg)
end)
...
RegisterNetEvent('rl-banking:client:bank:openUI')
AddEventHandler('rl-banking:client:bank:openUI', function() -- this one bank from target models
	if not bMenuOpen then
		TriggerEvent('animations:client:EmoteCommandStart', {"ATM"})

		RLCore.Functions.Progressbar("atm", "Opening Bank", 4500, false, true, {
			...
			RLCore.Functions.Notify('Canceled', 'warning')
			TriggerEvent('animations:client:EmoteCommandStart', {"c"})
		end)
	end
end)
RegisterNetEvent('rl-banking:client:atm:openUI')
AddEventHandler('rl-banking:client:atm:openUI', function() -- this opens ATM
	if not bMenuOpen then
		TriggerEvent('animations:client:EmoteCommandStart', {"ATM"})

		RLCore.Functions.Progressbar("atm", "Opening ATM", 4500, false, true, {
			disableMovement = true,
			disableCarMovement = true,
			disableMouse = false,
			disableCombat = true,
...
exports['qb-target']:AddTargetModel(ATMS,  {
    options = {
        {
            type = "client",
            event = "rl-banking:client:atm:openUI",
...
exports['qb-target']:AddBoxZone("Bank1", vector3(149.07, -1041.16, 29.54), 1.5, 4.5, {
	...
	maxZ = 30.5,
		...
		options = {
			{
            	type = "client",
            	event = "rl-banking:client:bank:openUI",
