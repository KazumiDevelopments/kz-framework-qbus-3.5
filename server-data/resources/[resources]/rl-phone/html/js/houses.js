...
$(document).on('click', '.house-key-delete', function(e){
    ...
    $.post('http://rl-phone/RemoveKeyholder', JSON.stringify({
        HolderData: Data,
...
$(document).on('click', '#myhouse-option-transfer-confirm', function(e){
    ...
    $.post('http://rl-phone/TransferCid', JSON.stringify({
        newBsn: NewBSN,
        HouseData: CurrentHouseData,
        ...
        if (CanTransfer) {
            ...
            RL.Phone.Notifications.Add("fas fa-home", "Houses", "This is an invalid BSN number", "#27ae60", 2500);
