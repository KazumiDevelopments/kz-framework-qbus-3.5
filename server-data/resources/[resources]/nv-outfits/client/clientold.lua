...
RegisterNetEvent("nv-outfits:client:tryUI")
AddEventHandler("nv-outfits:client:tryUI", function(outfits, tsd)
    local plyPed = PlayerPedId()
    local plyCoords = GetEntityCoords(plyPed)
    if tsd then
        TriggerEvent("nv-outfits:client:openUI", outfits)
        return
    end
...
RegisterNetEvent("nv-outfits:client:openUI")
AddEventHandler("nv-outfits:client:openUI", function(outfits)
    local html = ""
...
RegisterNetEvent("nv-outfits:client:updateUI")
AddEventHandler("nv-outfits:client:updateUI", function(outfits)
    local html = ""
...
RegisterNetEvent("nv-outfits:client:SetClothing")
AddEventHandler("nv-outfits:client:SetClothing", function(data)
...
RegisterNUICallback('CreateOutfit', function(data)
    ...
    TriggerServerEvent("nv-outfits:server:create", data.slot, data.name, temp_data)
end)
