...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if fireworkTime > 0 and fireworkLoc ~= nil then
            DrawText3Ds(fireworkLoc.x, fireworkLoc.y, fireworkLoc.z, "Fireworks Over ~r~"..fireworkTime)
        end
    end
end)
...
AddEventHandler("fireworks:client:UseFirework", function(itemName, assetName)
    RLCore.Functions.Progressbar("spawn_object", "Placing Fireworks..", 3000, false, true, {
