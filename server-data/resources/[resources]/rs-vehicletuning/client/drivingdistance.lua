                ...
                if seat == ped then
                    if not CheckDone then
                        if vehiclemeters == -1 then
                            CheckDone = true
                            RLCore.Functions.TriggerCallback('rs-vehicletuning:server:IsVehicleOwned', function(IsOwned)
                                if IsOwned then
                ...
                if vehiclemeters ~= -1 then
                    if seat == ped then
                        if previousvehiclepos ~= nil then
                            ...
                            if DamageKey ~= nil then
                                ...
                                if chance == odd then
                                    for k, v in pairs(Config.Damages) do
                                        ...
                                        RLCore.Functions.TriggerCallback('rs-vehicletuning:server:SetPartLevel', function(result)
                            ...
                            RLCore.Functions.TriggerCallback('rs-vehicletuning:server:UpdateDrivingDistance', function(result)
