				...
				if CheckWeapon(newWeap) then
					if holstered then
						if RLCore.Functions.GetPlayerData().job.name == "police" then
							...
							canFire = false
							TaskPlayAnimAdvanced(PlayerPedId(), "reaction@intimidation@1h", "intro", GetEntityCoords(PlayerPedId(), true), 0, 0, rot, 1.0, 1.0, -1, 50, 0, 0, 0)
							Citizen.Wait(600)
							SetCurrentPedWeapon(PlayerPedId(), newWeap, true)
							currWeapon = newWeap
							Citizen.Wait(1400)
					...
					elseif newWeap ~= currWeapon and CheckWeapon(currWeapon) then
						...
						if RLCore.Functions.GetPlayerData().job.name == "police" then
							...
							SetCurrentPedWeapon(PlayerPedId(), GetHashKey('WEAPON_UNARMED'), true)
							TaskPlayAnimAdvanced(PlayerPedId(), "reaction@intimidation@1h", "intro", GetEntityCoords(PlayerPedId(), true), 0, 0, rot, 1.0, 1.0, -1, 50, 0, 0, 0, 0)
							Citizen.Wait(600)
							SetCurrentPedWeapon(PlayerPedId(), newWeap, true)
							currWeapon = newWeap
							Citizen.Wait(1400)
