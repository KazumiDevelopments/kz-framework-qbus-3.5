...
RegisterNetEvent('rl-admin:client:toggleNoclip')
AddEventHandler('rl-admin:client:toggleNoclip', function()
    toggleNoClipMode()
end)
...
Citizen.CreateThread( function()
    ...
    function handleMovement(xVect,yVect)
        if ( IsControlJustPressed( 1, changeSpeedKey ) or IsDisabledControlJustPressed( 1, changeSpeedKey ) ) then
            ...
            RLCore.Functions.Notify("Current speed: ".. speeds[travelSpeed])
