...
local function SetClosestHouse()
    ...
    if not IsInside then
        ...
        if ClosestHouse ~= nil and tonumber(dist) < 30 then
            RLCore.Functions.TriggerCallback('qb-houses:server:ProximityKO', function(key, owned)
                HasHouseKey = key
                isOwned = owned
            end, ClosestHouse)
        end
...
local function setHouseLocations()
    if ClosestHouse ~= nil then
        RLCore.Functions.TriggerCallback('qb-houses:server:getHouseLocations', function(result)
            if result ~= nil then
...
local function LoadDecorations(house)
	if Config.Houses[house].decorations == nil or next(Config.Houses[house].decorations) == nil then
		RLCore.Functions.TriggerCallback('qb-houses:server:getHouseDecorations', function(result)
...
local function getKeyHolders()
    ...
    local p = promise.new()
    RLCore.Functions.TriggerCallback('qb-houses:server:getHouseKeyHolders', function(holders)
        p:resolve(holders)
    end,ClosestHouse)
...
function HouseKeysMenu()
    ...
    if holders == nil or next(holders) == nil then
        RLCore.Functions.Notify(Lang:t("error.no_key_holders"), "error", 3500)
        CloseMenuFull()
    else
        keyholderMenu = {}
...
local function getDataForHouseTier(house, coords)
    ...
    local shells = {
        [1] = function(coords) return exports['rl-interior']:CreateApartmentShell(coords) end,
        [2] = function(coords) return exports['rl-interior']:CreateTier1House(coords) end,
        [3] = function(coords) return exports['rl-interior']:CreateTrevorsShell(coords) end,
        [4] = function(coords) return exports['rl-interior']:CreateCaravanShell(coords) end,
        [5] = function(coords) return exports['rl-interior']:CreateLesterShell(coords) end,
        [6] = function(coords) return exports['rl-interior']:CreateRanchShell(coords) end,
        --WAREHOUSES
        [7] = function(coords) return exports['rl-interior']:CreateWarehouse1(coords) end,
        [8] = function(coords) return exports['rl-interior']:CreateWarehouse2(coords) end,
        [9] = function(coords) return exports['rl-interior']:CreateWarehouse3(coords) end,
        --HIGHEND
        [10] = function(coords) return exports['rl-interior']:CreateHighend1(coords) end,
        [11] = function(coords) return exports['rl-interior']:CreateHighend2(coords) end,
        [12] = function(coords) return exports['rl-interior']:CreateHighend3(coords) end,
        --DELUXE
        [13] = function(coords) return exports['rl-interior']:CreateHighend(coords) end,
        [14] = function(coords) return exports['rl-interior']:CreateHighendV2(coords) end,
        [15] = function(coords) return exports['rl-interior']:CreateMichael(coords) end,
        --OFFICE
        [16] = function(coords) return exports['rl-interior']:CreateOffice2(coords) end,
        [17] = function(coords) return exports['rl-interior']:CreateOfficeBig(coords) end,
        --STORE SHELLS
        [18] = function(coords) return exports['rl-interior']:CreateBarber(coords) end,
        [19] = function(coords) return exports['rl-interior']:CreateGunstore(coords) end,
        [20] = function(coords) return exports['rl-interior']:CreateStore1(coords) end,
        [21] = function(coords) return exports['rl-interior']:CreateStore2(coords) end,
        [22] = function(coords) return exports['rl-interior']:CreateStore3(coords) end,
        --MEDIUM HOUSING
        [23] = function(coords) return exports['rl-interior']:CreateFranklinAunt(coords) end,
        [24] = function(coords) return exports['rl-interior']:CreateMedium2(coords) end,
        [25] = function(coords) return exports['rl-interior']:CreateMedium3(coords) end,
        --DRUG LABS
        [26] = function(coords) return exports['rl-interior']:CreateCoke(coords) end,
        [27] = function(coords) return exports['rl-interior']:CreateCoke2(coords) end,
        [28] = function(coords) return exports['rl-interior']:CreateMeth(coords) end,
        [29] = function(coords) return exports['rl-interior']:CreateWeed2(coords) end,
        --GARAGE SHELLS
        [23] = function(coords) return exports['rl-interior']:CreateGarageLow(coords) end,
        [24] = function(coords) return exports['rl-interior']:CreateGarageMed(coords) end,
        [25] = function(coords) return exports['rl-interior']:CreateGarageHigh(coords) end

    }

    if not shells[houseTier] then
        RLCore.Functions.Notify(Lang:t("error.invalid_tier"), 'error')
        return nil
    else
...
--         return exports['rl-interior']:CreateApartmentShell(coords)
--     elseif Config.Houses[house].tier == 2 then
--         return exports['rl-interior']:CreateTier1House(coords)
--     elseif Config.Houses[house].tier == 3 then
--         return exports['rl-interior']:CreateTrevorsShell(coords)
--     elseif Config.Houses[house].tier == 4 then
--         return exports['rl-interior']:CreateCaravanShell(coords)
--     elseif Config.Houses[house].tier == 5 then
--         return exports['rl-interior']:CreateLesterShell(coords)
--     elseif Config.Houses[house].tier == 6 then
--         return exports['rl-interior']:CreateRanchShell(coords)
--     elseif Config.Houses[house].tier == 7 then
--         return exports['rl-interior']:CreateFranklinAunt(coords)
--     elseif Config.Houses[house].tier == 8 then
--         return exports['rl-interior']:CreateMedium2(coords)
--     elseif Config.Houses[house].tier == 9 then
--         return exports['rl-interior']:CreateMedium3(coords)
--     elseif Config.Houses[house].tier == 10 then
--         return exports['rl-interior']:CreateBanham(coords)
--     elseif Config.Houses[house].tier == 11 then
--         return exports['rl-interior']:CreateWestons(coords)
--     elseif Config.Houses[house].tier == 12 then
--         return exports['rl-interior']:CreateWestons2(coords)
--     elseif Config.Houses[house].tier == 13 then
--         return exports['rl-interior']:CreateClassicHouse(coords)
--     elseif Config.Houses[house].tier == 14 then
--         return exports['rl-interior']:CreateClassicHouse2(coords)
--     elseif Config.Houses[house].tier == 15 then
--         return exports['rl-interior']:CreateClassicHouse3(coords)
--     elseif Config.Houses[house].tier == 16 then
--         return exports['rl-interior']:CreateHighend1(coords)
--     elseif Config.Houses[house].tier == 17 then
--         return exports['rl-interior']:CreateHighend2(coords)
--     elseif Config.Houses[house].tier == 18 then
--         return exports['rl-interior']:CreateHighend3(coords)
--     elseif Config.Houses[house].tier == 19 then
--         return exports['rl-interior']:CreateHighend(coords)
--     elseif Config.Houses[house].tier == 20 then
--         return exports['rl-interior']:CreateHighendV2(coords)
--     elseif Config.Houses[house].tier == 21 then
--         return exports['rl-interior']:CreateMichael(coords)
--     elseif Config.Houses[house].tier == 22 then
--         return exports['rl-interior']:CreateStashHouse(coords)
--     elseif Config.Houses[house].tier == 23 then
--         return exports['rl-interior']:CreateStashHouse2(coords)
--     elseif Config.Houses[house].tier == 24 then
--         return exports['rl-interior']:CreateContainer(coords)
--     elseif Config.Houses[house].tier == 25 then
--         return exports['rl-interior']:CreateGarageLow(coords)
--     elseif Config.Houses[house].tier == 26 then
--         return exports['rl-interior']:CreateGarageMed(coords)
--     elseif Config.Houses[house].tier == 27 then
--         return exports['rl-interior']:CreateGarageHigh(coords)
--     elseif Config.Houses[house].tier == 28 then
--         return exports['rl-interior']:CreateOffice1(coords)
--     elseif Config.Houses[house].tier == 29 then
--         return exports['rl-interior']:CreateOffice2(coords)
--     elseif Config.Houses[house].tier == 30 then
--         return exports['rl-interior']:CreateOfficeBig(coords)
--     elseif Config.Houses[house].tier == 31 then
--         return exports['rl-interior']:CreateBarber(coords)
--     elseif Config.Houses[house].tier == 32 then
--         return exports['rl-interior']:CreateGunstore(coords)
--     elseif Config.Houses[house].tier == 33 then
--         return exports['rl-interior']:CreateStore1(coords)
--     elseif Config.Houses[house].tier == 34 then
--         return exports['rl-interior']:CreateStore2(coords)
--     elseif Config.Houses[house].tier == 35 then
--         return exports['rl-interior']:CreateStore3(coords)
--     elseif Config.Houses[house].tier == 36 then
--         return exports['rl-interior']:CreateWarehouse1(coords)
--     elseif Config.Houses[house].tier == 37 then
--         return exports['rl-interior']:CreateWarehouse2(coords)
--     elseif Config.Houses[house].tier == 38 then
--         return exports['rl-interior']:CreateWarehouse3(coords)
--     elseif Config.Houses[house].tier == 39 then
--         return exports['rl-interior']:CreateK4Coke(coords)
--     elseif Config.Houses[house].tier == 40 then
--         return exports['rl-interior']:CreateK4Meth(coords)
--     elseif Config.Houses[house].tier == 41 then
--         return exports['rl-interior']:CreateK4Weed(coords)
--     elseif Config.Houses[house].tier == 42 then
--         return exports['rl-interior']:CreateContainer2(coords)
--     elseif Config.Houses[house].tier == 43 then
--         return exports['rl-interior']:CreateFurniStash1(coords)
--     elseif Config.Houses[house].tier == 44 then
--         return exports['rl-interior']:CreateFurniStash3(coords)
--     elseif Config.Houses[house].tier == 45 then
--         return exports['rl-interior']:CreateFurniLow(coords)
--     elseif Config.Houses[house].tier == 46 then
--         return exports['rl-interior']:CreateFurniMid(coords)
--     elseif Config.Houses[house].tier == 47 then
--         return exports['rl-interior']:CreateFurniMotel(coords)
--     elseif Config.Houses[house].tier == 48 then
--         return exports['rl-interior']:CreateFurniMotelClassic(coords)
--     elseif Config.Houses[house].tier == 49 then
--         return exports['rl-interior']:CreateFurniMotelStandard(coords)
--     elseif Config.Houses[house].tier == 50 then
--         return exports['rl-interior']:CreateFurniMotelHigh(coords)
--     elseif Config.Houses[house].tier == 51 then
--         return exports['rl-interior']:CreateFurniMotelModern(coords)
--     elseif Config.Houses[house].tier == 52 then
--         return exports['rl-interior']:CreateFurniMotelModern2(coords)
--     elseif Config.Houses[house].tier == 53 then
--         return exports['rl-interior']:CreateFurniMotelModern3(coords)
--     elseif Config.Houses[house].tier == 54 then
--         return exports['rl-interior']:CreateCoke(coords)
--     elseif Config.Houses[house].tier == 55 then
--         return exports['rl-interior']:CreateCoke2(coords)
--     elseif Config.Houses[house].tier == 56 then
--         return exports['rl-interior']:CreateMeth(coords)
--     elseif Config.Houses[house].tier == 57 then
--         return exports['rl-interior']:CreateWeed(coords)
--     elseif Config.Houses[house].tier == 58 then
--         return exports['rl-interior']:CreateWeed2(coords)
--     elseif Config.Houses[house].tier == 59 then
--         return exports['rl-interior']:CreateMansion(coords)
--     elseif Config.Houses[house].tier == 60 then
--         return exports['rl-interior']:CreateMansion2(coords)
--     elseif Config.Houses[house].tier == 61 then
--         return exports['rl-interior']:CreateMansion3(coords)
--     else
--         RLCore.Functions.Notify(Lang:t("error.invalid_tier"), 'error')
--     end
-- end
    ...
    if dist <= 1.5 then
        if HasHouseKey then
            if Config.Houses[ClosestHouse].locked then
                ...
                RLCore.Functions.Notify(Lang:t("success.unlocked"), "success", 2500)
            else
                TriggerServerEvent('qb-houses:server:lockHouse', true, ClosestHouse)
                RLCore.Functions.Notify(Lang:t("error.locked"), "error", 2500)
            end
        else
            RLCore.Functions.Notify(Lang:t("error.no_keys"), "error", 3500)
        end
    else
        RLCore.Functions.Notify(Lang:t("error.no_door"), "error", 3500)
    end
end)
...
RegisterNetEvent('qb-houses:client:RingDoor', function(player, house)
    if ClosestHouse == house and IsInside then
        ...
        RLCore.Functions.Notify(Lang:t("info.door_ringing"))
    end
end)
...
RegisterNetEvent('qb-houses:client:giveHouseKey', function()
    ...
    if player ~= -1 and distance < 2.5 and ClosestHouse ~= nil then
        ...
        if housedist < 10 then
            ...
            RLCore.Functions.Notify(Lang:t("error.no_door"), "error")
        end
    elseif ClosestHouse == nil then
        RLCore.Functions.Notify(Lang:t("error.no_house"), "error")
    else
        RLCore.Functions.Notify(Lang:t("error.no_one_near"), "error")
    end
end)
...
RegisterNetEvent('qb-houses:client:removeHouseKey', function()
    if ClosestHouse ~= nil then
        ...
        local housedist = #(pedpos - vector3(Config.Houses[ClosestHouse].coords.enter.x, Config.Houses[ClosestHouse].coords.enter.y, Config.Houses[ClosestHouse].coords.enter.z))
        if housedist <= 5 then
            RLCore.Functions.TriggerCallback('qb-houses:server:getHouseOwner', function(result)
                if RLCore.Functions.GetPlayerData().citizenid == result then
                    HouseKeysMenu()
                else
                    RLCore.Functions.Notify(Lang:t("error.not_owner"), "error")
                end
            end, ClosestHouse)
        else
            RLCore.Functions.Notify(Lang:t("error.no_door"), "error")
...
RegisterNetEvent('qb-houses:client:setupHouseBlips', function() -- Setup owned on load
    CreateThread(function()
        ...
        if LocalPlayer.state['isLoggedIn'] then
            RLCore.Functions.TriggerCallback('qb-houses:server:getOwnedHouses', function(ownedHouses)
                if ownedHouses then
...
RegisterNetEvent('qb-houses:client:setStash') 
AddEventHandler('qb-houses:client:setStash', function(data)
    local ped = PlayerPedId()
    local pos = GetEntityCoords(ped)
    ...
    if IsInside then
        ...
        RLCore.Functions.Notify(Lang:t("error.not_in_house"), "error")
    end
end)

RegisterNetEvent('qb-houses:client:setOutfit') 
AddEventHandler('qb-houses:client:setOutfit', function(data)
    local ped = PlayerPedId()
    local pos = GetEntityCoords(ped)
    local coords = {x = pos.x, y = pos.y, z = pos.z}
    print("IM TRIGGERED")
...
RegisterNetEvent('qb-houses:client:setLogout') 
AddEventHandler('qb-houses:client:setLogout', function(data)
    local ped = PlayerPedId()
    local pos = GetEntityCoords(ped)
    local coords = {x = pos.x, y = pos.y, z = pos.z}
    if IsInside then
                        ...
                        if not Config.Houses[ClosestHouse].IsRaming then
                            ...
                            Skillbar.Start({
                                ...
                                if RamsDone + 1 >= Config.RamsNeeded then
                                    TriggerServerEvent('qb-houses:server:lockHouse', false, ClosestHouse)
                                    RLCore.Functions.Notify(Lang:t("success.home_invasion"), 'success')
                                ...
                                RamsDone = 0
                                TriggerServerEvent('qb-houses:server:SetRamState', false, ClosestHouse)
                                RLCore.Functions.Notify(Lang:t("error.failed_invasion"), 'error')
                                DoRamAnimation(false)
                            end)
                            TriggerServerEvent('qb-houses:server:SetRamState', true, ClosestHouse)
                        else
                            RLCore.Functions.Notify(Lang:t("error.inprogress_invasion"), 'error')
                        end
                    else
                        RLCore.Functions.Notify(Lang:t("error.already_open"), 'error')
                    end
                else
                    RLCore.Functions.Notify(Lang:t("error.no_house"), "error")
                end
...
RegisterNetEvent('qb-houses:client:ResetHouse', function()
    if ClosestHouse ~= nil then
        ...
        if Config.Houses[ClosestHouse].IsRammed then
            ...
            TriggerServerEvent('qb-houses:server:lockHouse', true, ClosestHouse)
            RamsDone = 0
            RLCore.Functions.Notify(Lang:t("success.lock_invasion"), 'success')
        else
            RLCore.Functions.Notify(Lang:t("error.no_invasion"), 'error')
        end
    end
end)
...
RegisterNUICallback('HasEnoughMoney', function(data, cb)
    RLCore.Functions.TriggerCallback('qb-houses:server:HasEnoughMoney', function(hasEnough)
    end, data.objectData)
end)
                    ...
                    if outfitLocation ~= nil then
                        if #(pos - vector3(outfitLocation.x, outfitLocation.y, outfitLocation.z)) <= 1.5 then
                            ...
                            if(GetDistanceBetweenCoords(pos, outfitLocation.x, outfitLocation.y, outfitLocation.z, true) < 1.5)then
                                ...
                                if IsControlJustPressed(0, Keys["E"]) then
									TriggerEvent("rl-outfits-ido:client:openOutfits")
                                    TriggerServerEvent("InteractSound_SV:PlayOnSource", "Clothes1", 0.4)
                                end
