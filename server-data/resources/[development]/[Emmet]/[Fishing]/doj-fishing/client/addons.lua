...
AddEventHandler('doj:client:SellillegalFish', function() 
	RLCore.Functions.TriggerCallback('RLCore:HasItem', function(HasItem)
		if HasItem then
			...
			RLCore.Functions.Notify('Welcome, '..charinfo.firstname..' '..charinfo.lastname)
			exports['qb-menu']:openMenu({
				{
					header = "Pearl's Seafood Restaurant",
					isMenuHeader = true
			...
			RLCore.Functions.Notify('You cannot sell to us at the moment, sorry for the inconvenience', 'error', 3500)
		end
	end, "pearlscard")
end)
