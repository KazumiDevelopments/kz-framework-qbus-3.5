...
RegisterCommand('e', function(source, args, raw) EmoteCommandStart(args) end)
RegisterCommand('emote', function(source, args, raw) EmoteCommandStart(args) end)
if Config.SqlKeybinding then
