...
function TokoVoip.initialize(self)
	...
	Citizen.CreateThread(function()
		while (true) do
			...
			elseif (IsControlJustPressed(0, 243)) then -- Switch proximity modes (normal / whisper / shout)
				...
				TriggerEvent('torchizm-hud:toggleTokoVOIP', self.mode)
				self:updateTokoVoipInfo();
			end
