                    ...
                    <div class="row">
                        <div class="col s12"> 
                            <ul class="collection">
                                ...
                                <li class="collection-item"><i class="fas fa-hourglass-half"></i> ${vehicleData[vehicle].payments == 0 ? 'No remaining payments.' : (vehicleData[vehicle].lastPayment) /60 + ' days until payment is due.'}</li>
                                `
...
$("#real-estate-create-form").submit(function (e) {
    e.preventDefault();
    $.post('http://phone/btnAttempCreateHouse', JSON.stringify({
...
$('#real-estate-transfers-form').submit(function (e) {
    e.preventDefault();
    $.post('http://phone/btnSellingHousePlayer', JSON.stringify({
...
$('#home-owner-transfer-form').submit(function (e) {
    e.preventDefault();
    $.post('http://phone/btnTransferHouse2', JSON.stringify({
...
$('#real-estate-delete-modal-accept').click(function () {
    $.post('http://phone/btnDeleteHouse', JSON.stringify({}));
